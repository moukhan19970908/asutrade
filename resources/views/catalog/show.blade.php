    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-1/4 hidden lg:block">
            <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                ...
                <div class="border border-gray-200 rounded-md p-2 max-h-[80vh] overflow-y-auto bg-gray-50">
                    <div class="mb-2">
                        <a href="{{ route('catalog.index') }}" class="block px-2 py-1 rounded hover:bg-white text-gray-700">
                           Все категории
                        </a>
                    </div>
                    @if(isset($categories))
                        @include('partials.category-tree', ['categories' => $categories, 'category' => $product->category])
                    @endif
                </div>
            </div>
        </div>
